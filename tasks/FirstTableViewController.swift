...
class FirstTableViewController:UITableViewController, UITextFieldDelegate, UIPopoverPresentationControllerDelegate
//, SKProductsRequestDelegate
{
    ...
    var colorNumber:Int = 1 // color to set up
    ...
    override func viewWillAppear(_ animated: Bool) {
        //print("\r\r\r________________\r 1 viewWillAppear")
