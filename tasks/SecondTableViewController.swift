...
class SecondTableViewController:UITableViewController, UITextFieldDelegate, UIPopoverPresentationControllerDelegate
    //, SKProductsRequestDelegate
{
    ...
    var colorNumber:Int = 2 // color to set up
...
//
    ...
    override func viewDidLoad() {
       ...
       //print("1 viewDidLoad")
        ...
        imageView.image   = UIImage(named: "listenter2")
